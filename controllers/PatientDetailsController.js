...
exports.updateUser = catchAsync(async (req, res, next) => {
    // update user
    const { isUpdateReport, biomarkers, testedAt, labName, username, email } = req.body;
    ...
    const updatedPatient = await Patient.findByIdAndUpdate({ _id: patient.id }, patient, {
        runValidators: false,
    });
...
exports.deleteUser = catchAsync(async (req, res, next) => {
    ...
    res.status(200).json({ status: "success", message: "Successfully deleted the patient" });
});
...
exports.deleteReport = catchAsync(async (req, res, next) => {
    ...
    const updatedPatient = await Patient.findByIdAndUpdate({ _id: patient._id }, patient, {
        runValidators: false,
    });
